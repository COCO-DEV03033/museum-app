...
(function () {
  ...
  var canvas = function () {
    try {
      $(`${this.containerSelector} .main-panel`).append(`<div class="canvas-holder" id="canvas-holder"><div class="content"><canvas id="c" style="left : 0px;"></canvas></div></div>`);
      const fabricCanvas = new fabric.Canvas('c').setDimensions({
        width: window.innerWidth * 0.65,
        height: window.innerHeight * 0.615
      })
      // fabricCanvas.drawImage(backgroundImage,0,0)
