...
(function () {
  ...
  var ImageEditor = function (containerSelector, buttons, shapes) {
    ...
    // backgroundImage.src = './screenshots/golf.jpg';
    // var context = this.canvas.getContext('2d');
    // backgroundImage.onload = function () {
    //   console.log(backgroundImage)
    //   context.drawImage(backgroundImage,0,0)
    // }
    fabric.Image.fromURL('./screenshots/golf.jpg', (img) => {
      img.set({
        left: 0,
        top: 0
      })
      ...
      var text = new fabric.Text('During the restoration process our experts interpreted the majority of the wall painting. \n as you can learn in this exhibition.\n But this one they did not succeed! :-(   Now this it your turn   :-)', {
        fill: '#046c1c',
        fontSize: 18,
        left: 50,
        top: 20
      ...
      // this.canvas.drawImage(img,0,0)
      var text1 = new fabric.Text('What those people are doing in the mid of 17th century ? \n Playing golf maybe ? - Excluded!', {
        fill: '#046c1c',
        fontWeight: 'bolder',
        fontSize: 18,
        left: 50,
      ...
      var text2 = new fabric.Text('Find an in terpretation draw and/or write on the\n pic and send to us, post on social media.', {
        fill: '#046c1c',
        fontSize: 18,
        left: 50,
        top: 170
