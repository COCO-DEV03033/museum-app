...
try {
  ...
  imgEditor.containerEl[0].ownerDocument.getElementsByClassName("canvas-holder")[0].style.overflow = 'hidden'
  // console.log('initialize image editor',imgEditor.containerEl[0].ownerDocument.getElementsByClassName("upper-canvas")[0]);
